...
namespace CRM.User.WebApp.Controllers
{
    ...
    public abstract class BaseController<TModel> : ODataController
    {
        ...
        protected readonly UserManager<Models.Basic.User.User> userManager;

        protected BaseController(ILogger<TModel> logger,
            UserDbContext userDbContext, UserManager<Models.Basic.User.User> userManager, IHttpContextAccessor httpContextAccessor)
        {
            this.logger = logger;
